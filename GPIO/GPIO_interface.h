...
void GPIO_vSetPinOutSpeed(u8 Copy_u8PortName ,u8 Copy_u8PinNum ,u32 Copy_u32OutSpeed );

/*===============   4-Function Set The PULL ( Almost Input ) ( OFF , UP , DOWN )  ===============*/
void GPIO_vSetPullType(u8 Copy_u8PortName ,u8 Copy_u8PinNum ,u32 Copy_u32PullType );
